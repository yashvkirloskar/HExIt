...
def testBasicIntegration(batch_size=4, game_size=5, simulations_per_state=500):
    ...
    assert(predicted_labels.shape == (2, batch_size, game_size)) # think this should be correct output
...
def testMultipleIterations(iterations=3, batch_size=4, game_size=5, simulations_per_state=500):
    ...
    train_inputs0, train_labels0 = mcts.generateExpertBatch()
    # first round of apprentice
    apprentice.train(train_inputs0, train_labels0)

    # second round of expert
    train_inputs1, train_labels1 = mcts_assisted.generateExpertBatch()
    # second round of apprentice
    apprentice.train(train_inputs1, train_labels1)

    # third round of expert
    train_inputs2, train_labels2 = mcts_assisted.generateExpertBatch()
    # third round of apprentice
    apprentice.train(train_inputs2, train_labels2)
